...
urlpatterns = [
    ...
    path("proveedores/<int:nit_proveedor>/articulos/", ProveedorArticuloView.as_view(), name="proveedor-articulo-create"),
    path("proveedores/<int:nit_proveedor>/articulos/<int:id_articulo>/", ProveedorArticuloView.as_view(), name="proveedor-articulo-update"),
