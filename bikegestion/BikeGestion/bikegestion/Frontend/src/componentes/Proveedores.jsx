            ...
            <header className="bg-[#121212] border-b border-white/5 flex justify-between items-center w-full px-8 h-16 fixed top-0 z-50">
                <div className="flex items-center gap-8">
                    <div className="flex flex-col">
                        <div className="text-[#FFEE00] font-headline-md italic-title uppercase tracking-tight text-sm leading-none">Gestión de Tienda</div>
                        <div className="text-[9px] font-label-caps uppercase tracking-[0.2em] text-white/40 font-bold mt-1">GESTIÓN PROFESIONAL</div>
                    </div>
                    <div className="flex items-center gap-6 ml-4">
                        <div className="flex items-center">
                            <span className="text-white font-black italic italic-title text-lg tracking-tighter">Bike</span>
                            <span className="text-[#FFEE00] font-black italic italic-title text-lg tracking-tighter">Gestión</span>
                        </div>
